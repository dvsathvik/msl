              ...
              <div className="hero-grid">
                ...
                <div className="hero-image-col">
                  <div className="hero-image-panel">
                    <img src="/assets/img/hero/2.webp" alt="Defense Automation Systems" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <SwiperSlide className="hero-slide slide-2">
            <div className="container hero-content">
              <div className="hero-grid">
                ...
                <div className="hero-image-col">
                  <div className="hero-image-panel">
                    <img src="/assets/img/hero/3.webp" alt="Intelligent Security Automation" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <SwiperSlide className="hero-slide slide-3">
            <div className="container hero-content">
              <div className="hero-grid">
                ...
                <div className="hero-image-col">
                  <div className="hero-image-panel">
                    <img src="/assets/img/hero/4.webp" alt="AI Secured Locker Systems" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <SwiperSlide className="hero-slide slide-4">
            <div className="container hero-content">
              <div className="hero-grid">
                ...
                <div className="hero-image-col">
                  <div className="hero-image-panel">
                    <img src="/assets/img/hero/5.webp" alt="Dynamic Traffic Signaling" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <SwiperSlide className="hero-slide slide-5">
            <div className="container hero-content">
              <div className="hero-grid">
                ...
                <div className="hero-image-col">
                  <div className="hero-image-panel">
                    <img src="/assets/img/hero/1.webp" alt="AI Driver Safety Systems" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <SwiperSlide className="hero-slide slide-6">
            <div className="container hero-content">
              <div className="hero-grid">
                ...
                <div className="hero-image-col">
                  <div className="hero-image-panel">
                    <img src="/assets/img/hero/7.webp" alt="Solar Profiling & SCADA" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <SwiperSlide className="hero-slide slide-7">
            <div className="container hero-content">
              <div className="hero-grid">
                ...
                <div className="hero-image-col">
                  <div className="hero-image-panel">
                    <img src="/assets/img/hero/8.webp" alt="Industrial IoT GateNodes" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <SwiperSlide className="hero-slide slide-8">
            <div className="container hero-content">
              <div className="hero-grid">
                ...
                <div className="hero-image-col">
                  <div className="hero-image-panel">
                    <img src="/assets/img/hero/9.webp" alt="SafeLoad Driver Safety" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <SwiperSlide className="hero-slide slide-9">
            <div className="container hero-content">
              <div className="hero-grid">
                ...
                <div className="hero-image-col">
                  <div className="hero-image-panel">
                    <img src="/assets/img/hero/iot.webp" alt="Escalator & Lift Diagnostics" />
                  </div>
                </div>
              </div>
            </div>
